...
# Volto Add-on build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/voltoadd_on/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/voltoadd_on",
    ...
    "repository_url": "https://github.com/collective/voltoadd_on",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/voltoadd_on/edit/main/docs/",
# }
...
ogp_site_name = "Volto Add-on Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Volto Add-onDocumentation"
...
latex_documents = [
    (
        "index",
        "Volto Add-onDocumentation.tex",
        "Volto Add-on Documentation",
